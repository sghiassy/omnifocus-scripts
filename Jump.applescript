(*
	...
	project(s) in the project view.

	# LICENSE #

	Copyright © 2015 Dan Byler (contact: dbyler@gmail.com)
	Additions by Shaheen Ghiassy (contact: https://github.com/sghiassy)
...
on main()
	tell application "OmniFocus"
		...
		tell default document
			tell the front document window to set the perspective name to "Projects"
		end tell
